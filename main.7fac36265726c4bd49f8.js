...
/***/ "./opinions/scripts/prepareOpinions.js":
/*!*********************************************!*\
  !*** ./opinions/scripts/prepareOpinions.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction prepareOpinions(event) {\n  const opinonsSectionRefference = \".opinions .comments\";\n  const comments = document.querySelectorAll(opinonsSectionRefference);\n\n  const commentRefference = \".comment\";\n\n  const expandedHeightProperty = \"--expanded-height\";\n  const collapsedHeightProperty = \"--collapsed-height\";\n  const collapsedClass = \"collapsed\";\n\n  for (let iteration = 0; iteration < comments.length; iteration++) {\n    const commentsSection = comments[iteration];\n    const commentsSectionHeight = Math.ceil(\n      commentsSection.getBoundingClientRect().height\n    );\n\n    const firstComment = commentsSection.querySelector(commentRefference);\n    const firstCommentHeight = Math.ceil(\n      firstComment.getBoundingClientRect().height\n    );\n    commentsSection.style.setProperty(\n      expandedHeightProperty,\n      `${commentsSectionHeight}px`\n    );\n    commentsSection.style.setProperty(\n      collapsedHeightProperty,\n      `${firstCommentHeight}px`\n    );\n\n    commentsSection.classList.add(collapsedClass);\n  }\n}\n\nwindow.addEventListener(\"load\", (event) => {\n  prepareOpinions(event);\n});\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (prepareOpinions);\n\n\n//# sourceURL=webpack:///./opinions/scripts/prepareOpinions.js?");
